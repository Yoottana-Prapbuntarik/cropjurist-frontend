  ...
  return (
    <div className="container-fluid p-5">
      ...
      <div className="row shadow-sm">
        {nonDisclosurePresenter.disclosureItems.linkItems.map((item: LinkItems, index: number) => {
          return (
            <div className="col-lg-3  col-12 my-3 text-link-IncorporationManager" key={index}>
      ...
      {nonDisclosurePresenter.disclosureDialog.map((item: DisclosureDialog, index: number) => {
        return (
          <Modal
