    ...
    <div className="container">
      {
        props.preferenceDataAPI.map((listPreferenceShare, index: number) => {
          return (
            <div className="row bg-light py-4 my-2" key={index}>
              ...
              <div className="col-lg-5 col-12">
                <div className="d-flex">
                  <button type="submit" className="btn btn-primary text-white w-100 mx-1 ">
                  ...
                  <button type="submit" className="btn btn-danger w-100 mx-1 ">
